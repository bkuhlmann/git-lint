...
RSpec.describe Git::Lint::Analyzers::Commits::Subjects::Duplication do
  ...
  describe ".id" do
    it "answers class ID" do
      expect(described_class.id).to eq("commits_subject_duplication")
    end
  end

  describe ".label" do
    it "answers class label" do
      expect(described_class.label).to eq("Commit Subject Duplication")
    end
  end
