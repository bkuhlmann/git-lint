...
RSpec.describe Git::Lint::Reporters::Branch do
  ...
  describe "#to_s" do
    ...
    context "with group errors" do
      ...
      let :analyzer do
        instance_spy Git::Lint::Analyzers::Commits::Subjects::Duplication,
                     class: class_spy(
                       Git::Lint::Analyzers::Commits::Subjects::Duplication,
                       label: "Commit Subject Duplication"
                     ),
                     commit: nil,
      ...
      it "answers detected issues" do
        ...
        expect(reporter.to_s).to eq(
          "Running Git Lint...\n" \
          "\n" \
          "\e[31mCommit Subject Duplication Error. A test hint.\n\e[0m" \
          "\n" \
          "1 commit inspected. \e[31m1 issue\e[0m detected " \
          "(\e[32m0 warnings\e[0m, \e[31m1 error\e[0m).\n"
        )
